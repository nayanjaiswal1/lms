...
func (h *Handler) RegisterRoutes(r chi.Router) {
	r.Group(func(r chi.Router) {
		r.Use(middleware.RequireOrgRole(middleware.RoleAdmin))
	...
	r.Group(func(r chi.Router) {
		r.Use(middleware.RequireOrgRole(middleware.RoleAdmin, middleware.RoleInstructor))
	...
	r.Group(func(r chi.Router) {
		r.Use(middleware.RequireOrgRole(middleware.RoleAdmin, middleware.RoleInstructor, middleware.RoleMentor))
