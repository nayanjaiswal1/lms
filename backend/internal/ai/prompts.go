...
// Apply writes anything into the real habit, diary-owned task, or
// newly-created habit records.
...
describing a new one), and new recurring goals/intentions the writer states.
