...
--
-- Squashes migrations 001-027 into a single baseline. Generated by replaying
-- every prior migration (the previous 001_baseline.sql plus 002-027) in
-- order against a scratch database and pg_dump'ing the resulting schema +
-- reference data (pg_dump --inserts, so it runs as plain SQL through a
-- single Exec, no COPY/psql metacommands). The dump's \restrict/\unrestrict
-- psql-only metacommands were stripped -- this file is executed as a single
-- SQL statement by the Go migration runner (db/migrate.go), not through psql.
--
-- All 27 prior migrations (001_baseline + 002_add_attempt_answer_override
-- through 027_add_org_ai_connector_config) replayed cleanly with no
-- exclusions. Next migration is 002_*.
-- ══════════════════════════════════════════════════════════════════════════
...
--
-- Name: certificate_rules; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.certificate_rules (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT certificate_rules_threshold_check CHECK (((threshold_percent >= 1) AND (threshold_percent <= 100)))
);
...
CREATE TABLE public.certificates (
    ...
    user_id uuid NOT NULL,
    course_id uuid NOT NULL,
    final_test_attempt_id uuid,
    issued_at timestamp with time zone DEFAULT now() NOT NULL,
    cert_uuid uuid DEFAULT gen_random_uuid() NOT NULL,
    issue_type text DEFAULT 'final_test'::text NOT NULL,
    issued_by uuid,
    CONSTRAINT certificates_issue_type_check CHECK ((issue_type = ANY (ARRAY['final_test'::text, 'manual'::text, 'threshold'::text])))
);
...
--
-- Name: course_content_proposals; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.course_content_proposals (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT course_content_proposals_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text]))),
    CONSTRAINT course_content_proposals_type_check CHECK ((type = ANY (ARRAY['notes'::text, 'assessment'::text])))
);
...
CREATE TABLE public.courses (
    ...
    CONSTRAINT courses_kind_check CHECK ((kind = ANY (ARRAY['org'::text, 'self'::text]))),
    ...
    CONSTRAINT courses_self_has_owner_check CHECK (((kind = 'org'::text) OR (owner_id IS NOT NULL))),
...
--
-- Name: final_test_attempts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: final_tests; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.final_tests (
    ...
    CONSTRAINT final_tests_passing_score_check CHECK (((passing_score_percent >= 1) AND (passing_score_percent <= 100))),
...
--
-- Name: gitlab_mr_reviews; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: gitlab_oauth_states; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: gitlab_org_config; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: interview_exp_comments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: interview_exp_votes; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.interview_exp_votes (
    ...
    CONSTRAINT interview_exp_votes_value_check CHECK ((value = ANY (ARRAY['-1'::integer, 1])))
);
...
CREATE TABLE public.interview_prep_plans (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    completed_at timestamp with time zone,
    plan_type text DEFAULT 'targeted'::text NOT NULL,
    technology text,
    difficulty text,
    category text DEFAULT 'technical'::text NOT NULL,
    CONSTRAINT interview_prep_plans_category_check CHECK ((category = ANY (ARRAY['technical'::text, 'behavioral'::text]))),
...
CREATE TABLE public.lab_sessions (
    ...
    repo_clone_status text,
    repo_clone_error text,
...
CREATE TABLE public.lesson_reflections (
    ...
    CONSTRAINT lesson_reflections_source_check CHECK ((source = ANY (ARRAY['manual'::text, 'ai'::text])))
);
...
--
-- Name: mcp_action_log; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mcp_auth_codes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mistake_entries; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.mistake_entries (
    ...
    resolved_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT mistake_entries_category_check CHECK ((category = ANY (ARRAY['tense'::text, 'article'::text, 'preposition'::text, 'subject_verb_agreement'::text, 'spelling'::text, 'sentence_fragment'::text, 'run_on'::text, 'vocabulary'::text, 'punctuation'::text, 'other'::text]))),
...
--
-- Name: org_ai_connector_config; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.practice_sessions (
    ...
    completed_at timestamp with time zone,
    category text DEFAULT 'technical'::text NOT NULL,
    CONSTRAINT practice_sessions_category_check CHECK ((category = ANY (ARRAY['technical'::text, 'behavioral'::text]))),
...
--
-- Name: user_sheet_settings; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.user_sheet_settings (
    ...
    growth_scheme text DEFAULT 'doubling'::text NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT user_sheet_settings_base_revision_days_check CHECK (((base_revision_days >= 1) AND (base_revision_days <= 365))),
    CONSTRAINT user_sheet_settings_growth_scheme_check CHECK ((growth_scheme = ANY (ARRAY['doubling'::text, 'ladder'::text, 'linear'::text])))
);
...
--
-- Data for Name: certificate_rules; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: course_content_proposals; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: final_test_attempts; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: final_tests; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: gitlab_mr_reviews; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: gitlab_oauth_states; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: gitlab_org_config; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: interview_exp_comments; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: interview_exp_votes; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: mcp_access_tokens; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: mcp_action_log; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: mcp_auth_codes; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: mistake_entries; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: org_ai_connector_config; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: user_sheet_settings; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: certificate_rules certificate_rules_course_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.certificate_rules
    ADD CONSTRAINT certificate_rules_course_unique UNIQUE (course_id);


--
-- Name: certificate_rules certificate_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: course_content_proposals course_content_proposals_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_pkey PRIMARY KEY (id);
...
--
-- Name: final_test_attempts final_test_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_test_attempts
    ADD CONSTRAINT final_test_attempts_pkey PRIMARY KEY (id);


--
-- Name: final_tests final_tests_course_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_tests
    ADD CONSTRAINT final_tests_course_unique UNIQUE (course_id);


--
-- Name: final_tests final_tests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_tests
    ADD CONSTRAINT final_tests_pkey PRIMARY KEY (id);
...
--
-- Name: gitlab_issues gitlab_issues_team_issue_iid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_issues
    ADD CONSTRAINT gitlab_issues_team_issue_iid_key UNIQUE (team_id, issue_iid);
...
--
-- Name: gitlab_mr_reviews gitlab_mr_reviews_mr_note_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_mr_reviews
    ADD CONSTRAINT gitlab_mr_reviews_mr_note_key UNIQUE (merge_request_id, note_id);


--
-- Name: gitlab_mr_reviews gitlab_mr_reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_mr_reviews
    ADD CONSTRAINT gitlab_mr_reviews_pkey PRIMARY KEY (id);


--
-- Name: gitlab_oauth_states gitlab_oauth_states_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_oauth_states
    ADD CONSTRAINT gitlab_oauth_states_pkey PRIMARY KEY (state);


--
-- Name: gitlab_org_config gitlab_org_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_org_config
    ADD CONSTRAINT gitlab_org_config_pkey PRIMARY KEY (org_id);
...
--
-- Name: gitlab_pipelines gitlab_pipelines_team_pipeline_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_pipelines
    ADD CONSTRAINT gitlab_pipelines_team_pipeline_key UNIQUE (team_id, pipeline_id);
...
--
-- Name: interview_exp_comments interview_exp_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_comments
    ADD CONSTRAINT interview_exp_comments_pkey PRIMARY KEY (id);
...
--
-- Name: interview_exp_votes interview_exp_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_votes
    ADD CONSTRAINT interview_exp_votes_pkey PRIMARY KEY (id);


--
-- Name: interview_exp_votes interview_exp_votes_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_votes
    ADD CONSTRAINT interview_exp_votes_unique UNIQUE (user_id, target_type, target_id);
...
--
-- Name: lesson_notes lesson_notes_user_module_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lesson_notes
    ADD CONSTRAINT lesson_notes_user_module_key UNIQUE (user_id, module_id);
...
--
-- Name: mcp_action_log mcp_action_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_action_log
    ADD CONSTRAINT mcp_action_log_pkey PRIMARY KEY (id);


--
-- Name: mcp_auth_codes mcp_auth_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_auth_codes
    ADD CONSTRAINT mcp_auth_codes_pkey PRIMARY KEY (code);
...
--
-- Name: mistake_entries mistake_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mistake_entries
    ADD CONSTRAINT mistake_entries_pkey PRIMARY KEY (id);
...
--
-- Name: org_ai_connector_config org_ai_connector_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.org_ai_connector_config
    ADD CONSTRAINT org_ai_connector_config_pkey PRIMARY KEY (org_id);
...
--
-- Name: project_handoffs project_handoffs_team_user_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_handoffs
    ADD CONSTRAINT project_handoffs_team_user_key UNIQUE (team_id, user_id);
...
--
-- Name: project_teams project_teams_gitlab_project_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_teams
    ADD CONSTRAINT project_teams_gitlab_project_id_key UNIQUE (gitlab_project_id);
...
ALTER TABLE ONLY public.user_permission_overrides
    ADD CONSTRAINT user_permission_overrides_pkey PRIMARY KEY (user_id, tenant_id, permission_id);
...
--
-- Name: user_sheet_settings user_sheet_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_sheet_settings
    ADD CONSTRAINT user_sheet_settings_pkey PRIMARY KEY (user_id, sheet_id);
...
--
-- Name: idx_content_proposals_proposer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_proposals_proposer ON public.course_content_proposals USING btree (proposer_id);


--
-- Name: idx_content_proposals_target_pending; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_proposals_target_pending ON public.course_content_proposals USING btree (target_course_id, status);
...
--
-- Name: idx_courses_owner_self; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_final_test_attempts_user_test; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_final_test_attempts_user_test ON public.final_test_attempts USING btree (user_id, final_test_id);
...
--
-- Name: idx_gitlab_issues_burndown; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gitlab_issues_burndown ON public.gitlab_issues USING btree (team_id, checkpoint_id, gl_closed_at);


--
-- Name: idx_gitlab_oauth_states_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gitlab_oauth_states_expires ON public.gitlab_oauth_states USING btree (expires_at);


--
-- Name: idx_gitlab_pipelines_team_updated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gitlab_pipelines_team_updated ON public.gitlab_pipelines USING btree (team_id, updated_at DESC);
...
--
-- Name: idx_interview_exp_comments_qna_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_interview_exp_comments_qna_parent ON public.interview_exp_comments USING btree (qna_id, parent_id);
...
--
-- Name: idx_interview_exp_votes_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_interview_exp_votes_target ON public.interview_exp_votes USING btree (target_type, target_id);
...
--
-- Name: idx_lesson_notes_org_module; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_lesson_notes_org_module ON public.lesson_notes USING btree (org_id, module_id);
...
--
-- Name: idx_mcp_access_tokens_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mcp_access_tokens_expires ON public.mcp_access_tokens USING btree (expires_at);


--
-- Name: idx_mcp_access_tokens_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_mcp_access_tokens_hash ON public.mcp_access_tokens USING btree (token_hash);


--
-- Name: idx_mcp_action_log_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mcp_action_log_user ON public.mcp_action_log USING btree (user_id, created_at DESC);


--
-- Name: idx_mcp_auth_codes_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mcp_auth_codes_expires ON public.mcp_auth_codes USING btree (expires_at);
...
--
-- Name: idx_mistake_entries_user_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mistake_entries_user_created ON public.mistake_entries USING btree (user_id, created_at DESC);
...
CREATE INDEX idx_user_permission_overrides_user_tenant ON public.user_permission_overrides USING btree (user_id, tenant_id);
...
--
-- Name: gitlab_org_config set_gitlab_org_config_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_gitlab_org_config_updated_at BEFORE UPDATE ON public.gitlab_org_config FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: certificate_rules certificate_rules_course_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.certificate_rules
    ADD CONSTRAINT certificate_rules_course_fkey FOREIGN KEY (course_id) REFERENCES public.courses(id) ON DELETE CASCADE;


--
-- Name: certificates certificates_attempt_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.certificates
    ADD CONSTRAINT certificates_attempt_fk FOREIGN KEY (final_test_attempt_id) REFERENCES public.final_test_attempts(id) ON DELETE CASCADE;
...
--
-- Name: course_content_proposals course_content_proposals_created_module_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_created_module_fk FOREIGN KEY (created_module_id) REFERENCES public.course_modules(id) ON DELETE SET NULL;


--
-- Name: course_content_proposals course_content_proposals_org_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_org_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: course_content_proposals course_content_proposals_proposer_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_proposer_fk FOREIGN KEY (proposer_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: course_content_proposals course_content_proposals_reviewed_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_reviewed_by_fk FOREIGN KEY (reviewed_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: course_content_proposals course_content_proposals_source_course_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_source_course_fk FOREIGN KEY (source_course_id) REFERENCES public.courses(id) ON DELETE SET NULL;


--
-- Name: course_content_proposals course_content_proposals_source_module_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_source_module_fk FOREIGN KEY (source_module_id) REFERENCES public.course_modules(id) ON DELETE SET NULL;


--
-- Name: course_content_proposals course_content_proposals_target_course_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_target_course_fk FOREIGN KEY (target_course_id) REFERENCES public.courses(id) ON DELETE CASCADE;


--
-- Name: course_content_proposals course_content_proposals_target_section_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_content_proposals
    ADD CONSTRAINT course_content_proposals_target_section_fk FOREIGN KEY (target_section_id) REFERENCES public.course_sections(id) ON DELETE SET NULL;
...
--
-- Name: courses courses_owner_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.courses
    ADD CONSTRAINT courses_owner_fk FOREIGN KEY (owner_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: final_test_attempts final_test_attempts_test_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_test_attempts
    ADD CONSTRAINT final_test_attempts_test_fk FOREIGN KEY (final_test_id) REFERENCES public.final_tests(id) ON DELETE CASCADE;


--
-- Name: final_test_attempts final_test_attempts_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_test_attempts
    ADD CONSTRAINT final_test_attempts_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: final_tests final_tests_course_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_tests
    ADD CONSTRAINT final_tests_course_fk FOREIGN KEY (course_id) REFERENCES public.courses(id) ON DELETE CASCADE;


--
-- Name: final_tests final_tests_org_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.final_tests
    ADD CONSTRAINT final_tests_org_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
...
--
-- Name: gitlab_issues gitlab_issues_assignee_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_issues
    ADD CONSTRAINT gitlab_issues_assignee_user_fk FOREIGN KEY (assignee_user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: gitlab_issues gitlab_issues_checkpoint_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_issues
    ADD CONSTRAINT gitlab_issues_checkpoint_fk FOREIGN KEY (checkpoint_id) REFERENCES public.project_checkpoints(id) ON DELETE SET NULL;


--
-- Name: gitlab_issues gitlab_issues_team_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_issues
    ADD CONSTRAINT gitlab_issues_team_fk FOREIGN KEY (team_id) REFERENCES public.project_teams(id) ON DELETE CASCADE;
...
--
-- Name: gitlab_mr_reviews gitlab_mr_reviews_mr_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_mr_reviews
    ADD CONSTRAINT gitlab_mr_reviews_mr_fk FOREIGN KEY (merge_request_id) REFERENCES public.gitlab_merge_requests(id) ON DELETE CASCADE;


--
-- Name: gitlab_mr_reviews gitlab_mr_reviews_reviewer_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_mr_reviews
    ADD CONSTRAINT gitlab_mr_reviews_reviewer_user_fk FOREIGN KEY (reviewer_user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: gitlab_oauth_states gitlab_oauth_states_installation_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_oauth_states
    ADD CONSTRAINT gitlab_oauth_states_installation_fk FOREIGN KEY (installation_id) REFERENCES public.gitlab_installations(id) ON DELETE CASCADE;


--
-- Name: gitlab_oauth_states gitlab_oauth_states_org_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_oauth_states
    ADD CONSTRAINT gitlab_oauth_states_org_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: gitlab_oauth_states gitlab_oauth_states_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_oauth_states
    ADD CONSTRAINT gitlab_oauth_states_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: gitlab_org_config gitlab_org_config_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_org_config
    ADD CONSTRAINT gitlab_org_config_org_id_fkey FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: gitlab_pipelines gitlab_pipelines_team_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gitlab_pipelines
    ADD CONSTRAINT gitlab_pipelines_team_fk FOREIGN KEY (team_id) REFERENCES public.project_teams(id) ON DELETE CASCADE;
...
--
-- Name: interview_exp_comments interview_exp_comments_author_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_comments
    ADD CONSTRAINT interview_exp_comments_author_fk FOREIGN KEY (author_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: interview_exp_comments interview_exp_comments_parent_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_comments
    ADD CONSTRAINT interview_exp_comments_parent_fk FOREIGN KEY (parent_id) REFERENCES public.interview_exp_comments(id) ON DELETE CASCADE;


--
-- Name: interview_exp_comments interview_exp_comments_qna_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_comments
    ADD CONSTRAINT interview_exp_comments_qna_fk FOREIGN KEY (qna_id) REFERENCES public.interview_exp_qna(id) ON DELETE CASCADE;
...
--
-- Name: interview_exp_votes interview_exp_votes_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interview_exp_votes
    ADD CONSTRAINT interview_exp_votes_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: lesson_notes lesson_notes_module_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lesson_notes
    ADD CONSTRAINT lesson_notes_module_fk FOREIGN KEY (module_id) REFERENCES public.course_modules(id) ON DELETE CASCADE;


--
-- Name: lesson_notes lesson_notes_org_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lesson_notes
    ADD CONSTRAINT lesson_notes_org_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: lesson_notes lesson_notes_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lesson_notes
    ADD CONSTRAINT lesson_notes_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: mcp_access_tokens mcp_access_tokens_connection_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_access_tokens
    ADD CONSTRAINT mcp_access_tokens_connection_fk FOREIGN KEY (connection_id) REFERENCES public.mcp_connections(id) ON DELETE CASCADE;


--
-- Name: mcp_action_log mcp_action_log_connection_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_action_log
    ADD CONSTRAINT mcp_action_log_connection_fk FOREIGN KEY (connection_id) REFERENCES public.mcp_connections(id) ON DELETE CASCADE;


--
-- Name: mcp_action_log mcp_action_log_org_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_action_log
    ADD CONSTRAINT mcp_action_log_org_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: mcp_action_log mcp_action_log_reverted_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_action_log
    ADD CONSTRAINT mcp_action_log_reverted_by_fk FOREIGN KEY (reverted_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: mcp_action_log mcp_action_log_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_action_log
    ADD CONSTRAINT mcp_action_log_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: mcp_auth_codes mcp_auth_codes_client_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_auth_codes
    ADD CONSTRAINT mcp_auth_codes_client_fk FOREIGN KEY (client_id) REFERENCES public.mcp_clients(client_id) ON DELETE CASCADE;


--
-- Name: mcp_auth_codes mcp_auth_codes_org_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_auth_codes
    ADD CONSTRAINT mcp_auth_codes_org_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: mcp_auth_codes mcp_auth_codes_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mcp_auth_codes
    ADD CONSTRAINT mcp_auth_codes_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: mistake_entries mistake_entries_module_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mistake_entries
    ADD CONSTRAINT mistake_entries_module_fk FOREIGN KEY (source_module_id) REFERENCES public.course_modules(id) ON DELETE SET NULL;


--
-- Name: mistake_entries mistake_entries_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mistake_entries
    ADD CONSTRAINT mistake_entries_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: org_ai_connector_config org_ai_connector_config_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.org_ai_connector_config
    ADD CONSTRAINT org_ai_connector_config_org_id_fkey FOREIGN KEY (org_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
...
--
-- Name: project_handoffs project_handoffs_team_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_handoffs
    ADD CONSTRAINT project_handoffs_team_fk FOREIGN KEY (team_id) REFERENCES public.project_teams(id) ON DELETE CASCADE;


--
-- Name: project_handoffs project_handoffs_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_handoffs
    ADD CONSTRAINT project_handoffs_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: public_attempts public_attempts_overridden_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.public_attempts
    ADD CONSTRAINT public_attempts_overridden_by_fkey FOREIGN KEY (overridden_by) REFERENCES public.users(id);
...
--
-- Name: srs_cards srs_cards_mistake_entry_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srs_cards
    ADD CONSTRAINT srs_cards_mistake_entry_fk FOREIGN KEY (mistake_entry_id) REFERENCES public.mistake_entries(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_permission_overrides
    ADD CONSTRAINT user_permission_overrides_tenant_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
...
--
-- Name: user_sheet_settings user_sheet_settings_sheet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_sheet_settings
    ADD CONSTRAINT user_sheet_settings_sheet_id_fkey FOREIGN KEY (sheet_id) REFERENCES public.sheets(id) ON DELETE CASCADE;


--
-- Name: user_sheet_settings user_sheet_settings_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_sheet_settings
    ADD CONSTRAINT user_sheet_settings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
