...
import { setAssessmentStatusAction, assignAssessmentAction } from "@/app/(app)/assessments/manage/actions";
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
          <DropdownMenuItem asChild>
            <Link href={`${ROUTES.manageAssessment(assessment.id)}?tab=settings`}>
