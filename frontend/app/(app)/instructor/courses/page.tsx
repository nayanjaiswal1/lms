    ...
    return (
      <div className="empty-state py-16">
        ...
        <Button asChild className="mt-4">
          <Link href={ROUTES.INSTRUCTOR_NEW_COURSE}>Create your first course</Link>
        </Button>
      </div>
    );
  }
          ...
          {courses.map((course) => (
            <tr key={course.id}>
              <td className="py-3 pr-4 font-medium">
                <Link className="hover:underline" href={ROUTES.instructorCourse(course.id)}>
                  {course.title}
                </Link>
              </td>
              ...
              <td className="py-3">
                <Link className="text-primary hover:underline text-xs" href={ROUTES.instructorCourseAnalytics(course.id)}>
                  Analytics
                </Link>
              </td>
            </tr>
  ...
  return (
    <main className="page-container py-8">
      <div className="page-header">
        ...
        <Button asChild>
          <Link href={ROUTES.INSTRUCTOR_NEW_COURSE}>
