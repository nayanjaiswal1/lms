    ...
    <main className="page-container py-8">
      <div className="page-header">
        ...
        <div className="flex items-center gap-4">
          <Link className="text-sm text-primary hover:underline" href={ROUTES.instructorEditCourse(id)}>
            Edit course
          </Link>
          <Link className="text-sm text-primary hover:underline" href={ROUTES.instructorCourseAnalytics(id)}>
            View analytics
          </Link>
        </div>
      </div>
