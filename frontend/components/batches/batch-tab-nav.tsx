...
import { MessageSquare, BookOpen, Users, BarChart3, GraduationCap } from "lucide-react";
...
export function BatchTabNav({ batchId }: BatchTabNavProps) {
  ...
  const TABS = [
    ...
    { href: ROUTES.mentoringBatchMentors(batchId), label: "Mentors", Icon: GraduationCap },
  ...
  return (
    <nav aria-label="Batch sections" className="mb-6 flex gap-1 border-b border-border">
