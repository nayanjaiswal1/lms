...
// prompts without any markup are unaffected. Shared by MCQ, subjective, and
// coding question prompts so all three render the same lightweight markup
// consistently instead of leaking raw ``` and ** characters into the UI.
