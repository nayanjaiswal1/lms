...
export function SettingsTab({ status, onChange, disableDraft }: SettingsTabProps) {
  return (
      ...
      <div className="flex flex-col gap-3">
        ...
        <RadioGroup value={status} onValueChange={(v) => onChange(v as CourseDraft["status"])} className="flex flex-col gap-3">
          <label className={cn(
            ...
            <RadioGroupItem disabled={disableDraft} value="draft" id="status-draft" className="mt-0.5" />
