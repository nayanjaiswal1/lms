...
The trap to avoid: blaming a teammate, a tool, or "the deploy pipeline" as the subject of the story. Even if a shared system was the proximate cause, talk about your role in the response and the fix, not who's at fault.
