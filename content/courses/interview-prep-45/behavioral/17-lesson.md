...
This question checks whether you generate improvements without being told to, and whether you can get something adopted, not just built. Plenty of candidates have a "cool thing I built" story with no adoption — a script that sat in their own repo that nobody else used. Interviewers are listening specifically for the adoption part.
...
- **Result** — adoption numbers or behavior change, not just "it worked for me."
