---
kind: lesson
id_key: interview-prep-45/day-07-behavioral
...
Don't just reread your stories. Map each one against the question categories interviewers actually pull from, and look for gaps.

| Story | Likely questions it answers |
|---|---|
| Resume walkthrough | "Tell me about yourself," "Walk me through your background" |
| Project deep dive (1 & 2) | "Tell me about a project you're proud of," "Describe something technically complex you built" |
| Conflict resolution | "Tell me about a disagreement," "Time you pushed back on an idea" |
