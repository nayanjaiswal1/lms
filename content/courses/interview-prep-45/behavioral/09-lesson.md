...
Same STAR shape as Day 4. The distinguishing element here is the **Action**: show the specific move you made to bridge the technical and non-technical sides, beyond just "we talked it through."
...
| Give them real options, not only "no" | Present the constraint as immovable with no alternative |
