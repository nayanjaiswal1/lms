...
- **Problem** — what was broken or missing, described in user/business terms, not just technical terms.
...
- **Challenges** — the hardest part, and specifically why it was hard (not "there was a lot to do").
