...
## Self-check: Celery and task queues (Day 8)
...
## Self-check: REST API design (Day 9)
...
## Self-check: API versioning and error handling (Day 10)
...
## Self-check: FastAPI background tasks (Day 11)
...
## Self-check: AWS S3 and storage (Day 12)
...
## Self-check: Docker and containerization (Day 13)
...
- [ ] Celery: reviewed and can explain without notes
- [ ] REST API Design: reviewed and can explain without notes
- [ ] API Versioning: reviewed and can explain without notes
- [ ] FastAPI Background Tasks: reviewed and can explain without notes
- [ ] AWS S3: reviewed and can explain without notes
- [ ] Docker: reviewed and can explain without notes
- [ ] Review all 12 system designs completed so far
- [ ] Pick the weakest 3 designs and re-practice them fully
