...
Above ~100MB (AWS recommends multipart starting around there, required above 5GB), split the upload into parts uploaded independently, enabling parallelism and resumability if a part fails.
