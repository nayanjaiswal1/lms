...
When a follow-up asks "how is this different from a similar system you already designed," the strongest answer names the specific scale/predictability difference driving the divergence, not just "it's bigger." Here, catalog size and demand predictability, not raw traffic volume, is what actually forces YouTube's CDN strategy away from Netflix's.
