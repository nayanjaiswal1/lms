...
- Append-only `payment_events` is the actual source of truth; any single mutable status field is a derived convenience and cannot support audits or disputes on its own.
