...
Situation/Task: what was the disagreement and what was at stake. Action: what you specifically did to resolve it, whether you escalated, compromised, gathered data to settle it objectively, or had a direct conversation. Result: the outcome and the relationship afterward. Weak answers avoid naming the actual disagreement or paint the other person as simply wrong; strong answers show you understood the other side's position before resolving it.
