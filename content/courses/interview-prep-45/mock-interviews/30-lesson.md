...
**Time allocation:** Clarification 3 min, algorithm 10 min, code 15 min, test 5 min. (Note: this totals 33; that's intentional slack, since a real interviewer lets you run slightly over on a clean solve.)
...
Notice the specific numbers, the specific technical actions, the honest "what I'd do differently." Vague answers ("we improved performance a lot") are the single most common behavioral failure. The fix is rehearsing with real numbers pulled from your own projects before the interview, not during it.
...
- Handled the wrap-up honestly, naming weaknesses instead of pretending the design was complete: /5
